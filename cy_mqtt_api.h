...
/**
 * Maximum timeout value in milliseconds for receiving acknowledgment packets for QoS1/QoS2 publish/Subscribe.
 *
 * \note
 *    This is the default value configured in the library. This value can be modified depending on network speed.
 *
 */
